...
<div class="box_white_under">
	...
	<section class="sec_breadcrumb">
		<ul class="list">
			...
			<li><a href="<?php echo esc_url(get_post_type_archive_link("column")); ?>" class="fade">調理コラム</a></li>
			<li><?php the_title(); ?></li>
		</ul>
	</section>
	<!-- /.sec_breadcrumb -->
	<section class="sec_contents post-column">
			...
			<div class="column-1 mt80 sp-mt8">
				...
				<div class="btn-white mt80 sp-mt8"><a href="<?php echo esc_url(get_post_type_archive_link("column")); ?>" class="btn_type2 fade">調理コラム一覧へ</a></div>
			</div>
		<?php if(get_field("sec_opencampus")): ?>
			<h3 class="headline-3-1 mt80 sp-mt8"><span>織田調理を<br class="sp">オープンキャンパスで<br class="sp">体験しよう！</span></h3>
			<div class="column-3 sp-column-2 column-h-center">
				<div>
					<a href="<?php echo esc_url(home_url('/')); ?>oc/" class="a-block">
						<div class="image-bg-line">
							<div class="image"><img src="/new/wp-content/uploads/2021/04/2021_oc_c_ボロネーゼss.jpg" alt=""></div>
						</div>
						<p class="text-size18 tac">毎回違うメニューに挑戦！</p>
					</a>
				</div>
				<div>
					<a href="<?php echo esc_url(home_url('/')); ?>oc/" class="a-block">
						<div class="image-bg-line">
							<div class="image"><img src="/new/wp-content/uploads/2021/04/2021_oc_c_寿司と茶碗蒸しss.jpg" alt=""></div>
						</div>
						<p class="text-size18 tac">様々なジャンルを体験できる！</p>
					</a>
				</div>
			</div>
			<div class="column-1">
