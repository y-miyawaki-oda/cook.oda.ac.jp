		...
		<footer<?php if(is_page(array("confirm", "thanks"))) echo ' class="pb00"'; ?>>
			<div class="footer_main">
				<div class="wrap">
					<div class="flex">
						<div class="school">
							<p class="logo"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/common/footer_logo.png" alt="織田調理師専門学校"></p>
			...
			<div class="footer_sns">
				<div class="wrap">
					...
					<ul class="list">
						<li><a href="https://www.instagram.com/oda_cook/" class="fade" target="_blank"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/common/sns_insta.png" alt="instagram"></a></li>
						<li><a href="https://lin.ee/uI6jIp4" class="fade" target="_blank"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/common/sns_line.png" alt="line"></a></li>
						<li><a href="https://www.youtube.com/user/suysok" class="fade" target="_blank"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/common/sns_youtube.png" alt="youtube"></a></li>
					</ul>
				</div>
			</div>
	...
	<?php endif; ?>
	<?php if(is_page(array("management", "pan", "culinary", "training", "fashiondesign_s", "fasiontechnical_s", "merchandising", "guidance", "tuition", "foreignstudentguideline", "tuitionsupport"))): ?>
	<script>
