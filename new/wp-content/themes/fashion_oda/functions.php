				...
				if($val["class"] !== "prev" && $val["class"] !== "next") {
					...
					if($oc_arr[$date_txt]["bread"] || $oc_arr[$date_txt]["group"] || $oc_arr[$date_txt]["chinese"] || $oc_arr[$date_txt]["japanese"] || $oc_arr[$date_txt]["western"] || $oc_arr[$date_txt]["confectionery"] || $oc_arr[$date_txt]["special"]) {
						...
						if($oc_arr[$date_txt]["bread"]) {
							$table .= '<li><a href="./oc"><img src="'.esc_url(get_template_directory_uri()).'/img/index/oc_icon_stylist_business.png" alt=""></a></li>';
						}
						if($oc_arr[$date_txt]["group"]) {
							$table .= '<li><a href="./oc"><img src="'.esc_url(get_template_directory_uri()).'/img/index/group_lunch.png" alt=""></a></li>';
						}
						if($oc_arr[$date_txt]["confectionery"]) {
							$table .= '<li><a href="./oc"><img src="'.esc_url(get_template_directory_uri()).'/img/index/oc_icon_design_technical.png" alt=""></a></li>';
						}
						if($oc_arr[$date_txt]["chinese"]) {
							$table .= '<li><a href="./oc"><img src="'.esc_url(get_template_directory_uri()).'/img/index/chinese_cook.png" alt=""></a></li>';
						}
						if($oc_arr[$date_txt]["japanese"]) {
							$table .= '<li><a href="./oc"><img src="'.esc_url(get_template_directory_uri()).'/img/index/japanese_cook.png" alt=""></a></li>';
						}
						if($oc_arr[$date_txt]["western"]) {
							$table .= '<li><a href="./oc"><img src="'.esc_url(get_template_directory_uri()).'/img/index/western_cook.png" alt=""></a></li>';
						}
						if($oc_arr[$date_txt]["special"]) {
							$table .= '<li><a href="./oc"><img src="'.esc_url(get_template_directory_uri()).'/img/index/special.png" alt=""></a></li>';
						}
						$table .= '</ul>';
					}
				}
